  ...
  - style:
    ...
    background:
      ...
      ornaments:
        - {}
    markup: >-
      <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path
      d="M84.5,69.5Q73,89,50.5,89Q28,89,20,69.5Q12,50,21,32.5Q30,15,50.5,14Q71,13,83.5,31.5Q96,50,84.5,69.5Z"
      stroke="none" stroke-width="0" fill="#4F46E5"></path></svg>
    _template: embed
  - style:
      ...
      textStyles: text-white undefined text-lg mb-0 font-bold
      contentOrder: labelHeadingsContent
    cardStyle:
      fillStyles: bg-accent1 opacity-100
      padding: pt-4 pb-4 pr-5 pl-5
